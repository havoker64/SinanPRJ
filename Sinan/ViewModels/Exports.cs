...
namespace Sinan.ViewModels
{
    public class Exports
    {
        ...
        [Display(Name = "Selecione o sorotipo")]
        [Column("srtSelect")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Acúmulo de líquidos com falta de ar")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Destino da viagem")]
        [Column("travelPlace")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Houveram casos parecidos na área de residência?")]
        [Column("areaKnlg")]
        public bool areaKnlg { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "O paciente utiliza medicamento de uso contínuo?")]
        [Column("pMedication")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Paciente encaminhado para outro serviço de saúde?")]
        [Column("pEncaminhation")]
        public bool pEncaminhation { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Nome do outro serviço")]
        [Column("ePlace")]
        public string? ePlace { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Motivo do encaminhamento")]
        [Column("motive")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Ocorreu Hospitalização")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Município do hospital")]
        [Column("hospMun")]
        ...
        //----------------------------------------------------------------------
        [Display(Name = "Caso autóctone do município?")]
        [Column("caseMun")]
        public string? caseMun { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "UF do caso")]
        [Column("munUf")]
        public string? munUf { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Município onde ocorreu")]
        [Column("munCon")]
        public string? munCon { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Bairro onde ocorreu o caso")]
        [Column("neighborhood")]
        public string? neighborhood { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Classificação do caso")]
        [Column("conClass")]
        public string? conClass { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Critério de Nução/Descarte")]
        [Column("criterion")]
        public string? criterion { get; set; }
        //----------------------------------------------------------------------
        [Display(Name = "Evolução do caso")]
        [Column("caseEvo")]
